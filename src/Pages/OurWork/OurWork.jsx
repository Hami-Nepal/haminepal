        ...
        <div className="our_work_act_of_kindness">
          <div className="kindnessContents">
            ...
            <p>
              ...
              requests aid.
              <br /> The objective of these works is to help people in whatever
              way possible and eradicate their problem in no time. Some of the
              cases might be an emergency situation. Team Hami Nepal gives an
